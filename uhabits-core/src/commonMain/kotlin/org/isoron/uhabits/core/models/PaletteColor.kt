...
data class PaletteColor(val paletteIndex: Int) {
    fun toCsvColor(): String {
        return if (paletteIndex in 0..19) {
            arrayOf(
                "#D32F2F", //  0 red
            ...
            val r = (paletteIndex shr 16) and 0xFF
            val g = (paletteIndex shr 8) and 0xFF
            val b = paletteIndex and 0xFF
            fun toHex(v: Int): String {
                val digits = "0123456789ABCDEF"
                return "${digits[(v shr 4) and 0x0F]}${digits[v and 0x0F]}"
            }
